...
layout: post
category: prepare
title: Năm nhất cao học làm Deep Learning, năm hai dự định chuyển sang mảng Lập trình ứng dụng (Development)
tagline: by A Tú
tags:
    - Nguyên tác
    ...
    - A Tú
excerpt: Năm nhất cao học làm Deep Learning, năm hai dự định chuyển sang mảng Lập trình ứng dụng (Development)
comment: false
---

<h1 align="center">
  Năm nhất cao học làm Deep Learning, năm hai dự định chuyển sang mảng Lập trình ứng dụng (Development)
</h1>
...
> Tác giả: A Tú (阿秀)
>
> Liên kết bài viết gốc: [https://mp.weixin.qq.com/s/OMg9JLt-qwgHxU7qR3MtEA](https://mp.weixin.qq.com/s/OMg9JLt-qwgHxU7qR3MtEA)

<img src="http://oss.interviewguide.cn/img/202205300101036.png" alt="gStore" style="zoom:50%;" />
<img src="http://oss.interviewguide.cn/img/202205300103516.png" alt="Deploy gStore thời cao học" style="zoom:50%;" />

Nhiều bạn học viên cao học năm nhất dành trọn thời gian nghiên cứu Machine Learning/Deep Learning để viết báo cáo khoa học, nhưng nhận thấy thị trường vị trí thuật toán AI cạnh tranh quá khốc liệt (thiếu Paper top đầu A/B khó xin việc) nên quyết định chuyển hướng sang Backend Development:

<img src="http://oss.interviewguide.cn/img/202205302300062.png" style="zoom: 33%;" />

---

### Lộ trình chuyển hướng sang Golang Backend trong 8 tháng:

1. **Thứ tự & Tỷ trọng phân bổ thời gian học tập**:
   - **Ngôn ngữ chủ đạo (Golang)**: 35% thời gian. Nắm vững cú pháp cốt lõi, cơ chế Goroutine, Channel, GC, Memory Model và hệ sinh thái Web Framework (Gin + GORM).
   - **Luyện giải thuật toán (LeetCode)**: 30% thời gian. Sử dụng chính Golang để cày đề mỗi tối (mục tiêu $250 \sim 300$ bài Medium).
   - **Khoa học máy tính cốt lõi (CS Fundamentals)**: 35% thời gian còn lại (Hệ điều hành, Mạng máy tính TCP/IP, MySQL Index/Transaction, Redis Caching).
2. **Tránh bẫy "Học vẹt Bát cổ văn"**: Học qua video để có cái nhìn trực quan, sau đó đọc sách chuyên sâu để hiểu bản chất vận hành bên dưới tầng hệ điều hành và mạng máy tính nhằm tự tin trả lời phỏng vấn chuyên sâu.
3. **Duy trì thể lực**: Dành tối thiểu 30 phút mỗi ngày chạy bộ hoặc tập luyện thể thao để duy trì nguồn năng lượng bền bỉ cho chặng đường dài.
