...
layout: post
category: prepare
title: Mùa tuyển dụng sắp tới, tôi lại định đổi ngôn ngữ chủ lực?
tagline: by A Tú
tags:
    - Nguyên tác
    ...
    - A Tú
excerpt: Mùa tuyển dụng sắp tới, tôi lại định đổi ngôn ngữ chủ lực?
comment: false
---

<h1 align="center">
  Mùa tuyển dụng sắp tới, tôi lại định đổi ngôn ngữ chủ lực?
</h1>
...
> Tác giả: A Tú (阿秀)
>
> Liên kết bài viết gốc: [https://mp.weixin.qq.com/s/USqdTuTpQUDNH-wcypJlvA](https://mp.weixin.qq.com/s/USqdTuTpQUDNH-wcypJlvA)

Tình huống sinh viên thạc sĩ theo định hướng C++ Backend, sau vài tháng tìm thực tập mùa xuân chưa như ý liền vội vàng chuyển sang học Golang và làm Demo chat cơ bản khi chỉ còn 1-2 tháng trước kỳ Tuyển dụng mùa thu:

---

### Phân tích: **"Thay tướng trước trận đánh - Điều tối kỵ trong tuyển dụng!"**

1. **Không nên chuyển đổi ngôn ngữ vào phút chót**:
   - Vị trí tuyển Golang tại các Big Tech (ByteDance, Tencent, Kuaishou, Bilibili) hoàn toàn chấp nhận ứng viên có nền tảng C++ vững chắc phỏng vấn và sang công ty đào tạo chuyển hệ.
   - Ngược lại, nếu bạn ứng tuyển vào các vị trí C++ (Hệ thống, Game Engine, Audio/Video, Cơ sở hạ tầng) mà chỉ biết Golang cơ bản thì sẽ bị loại ngay từ vòng hồ sơ.
2. **Không có thực tập thời cao học có sao không?**:
   - Phần lớn sinh viên cao học đều bị ràng buộc nghiên cứu tại phòng Lab của giáo sư, không được phép đi thực tập ngoài. Đây là tình trạng chung, nhà tuyển dụng hoàn toàn thấu hiểu.
   - Thay vì hoang mang, hãy dồn toàn lực đào sâu C++, nắm vững nguyên lý bộ nhớ, tối ưu hóa thuật toán và nắm chắc các câu hỏi phỏng vấn cốt lõi trên [Ghi chép thuật toán LeetCode](file:///d:/Work/Study/InterviewGuide-main/InterviewGuide-main/docs/notes/03-hunting_job/03-algorithm/03-leetcode/01-introduce.md).
3. **Quyết đoán và kiên định**: Tuyển dụng trường học chỉ cần thành thạo xuất sắc 1 ngôn ngữ chủ lực (C++, Java hoặc Go). Đừng đứng núi này trông núi nọ!
