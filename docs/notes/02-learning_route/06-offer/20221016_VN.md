...
layout: post
category: algorithm
title: Công ty nhỏ 10K vs Big Tech 20K - Nên chọn bên nào?
tagline: by A Tú
tags:
    - Nguyên tác
    - So sánh offer
    ...
    - A Tú
excerpt: Công ty nhỏ 10K vs Big Tech 20K - Nên chọn bên nào?
comment: false
---

<h1 align="center">Công ty nhỏ 10K vs Big Tech 20K - Nên chọn bên nào?</h1>
...
> Tác giả: A Tú (阿秀)
>
> Liên kết bài viết gốc: [https://mp.weixin.qq.com/s/Z7QEkOi37eLEwh25Hg3KcQ](https://mp.weixin.qq.com/s/Z7QEkOi37eLEwh25Hg3KcQ)

![Tin nhắn tư vấn](http://oss.interviewguide.cn/img/202209252256162.png)

Tình huống so sánh giữa 2 Offer:
1. **Shiyue Games (Quảng Châu - gần nhà)**: Backend Server chuyển sang ngôn ngữ Erlang. Lương $N \approx 10\text{K}$.
2. **Didi Chuxing (Bắc Kinh - Big Tech Hàng đầu)**: Điện toán đám mây (Cloud Platform R&D: Golang, Kubernetes, Docker). Lương $2N \approx 20\text{K}$.

---

### Phân tích và Lời khuyên: **Quyết định chọn Didi ngay lập tức!**

1. **Khoảng cách thu nhập quá lớn ($10\text{K}$ vs $20\text{K}$)**: Chênh lệch gấp đôi mức lương khởi điểm tạo ra tích lũy tài chính và vị thế deal lương hoàn toàn khác biệt.
2. **Tech Stack & Hệ sinh thái công nghệ**:
   - Ngôn ngữ Erlang trong game ngách có thị trường tuyển dụng hẹp, khó chuyển đổi.
   - Cloud Platform (Golang + K8s + Docker) tại Didi là xu hướng công nghệ chủ đạo của toàn cầu, nhu cầu tuyển dụng cực lớn.
3. **Giá trị thương hiệu Big Tech trên CV**: Đi làm $1 \sim 2$ năm tại Didi Bắc Kinh lấy đòn bẩy thương hiệu Big Tech vững chắc. Sau 2 năm, khi muốn quay về Quảng Châu/Thâm Quyến, bạn hoàn toàn có thể ứng tuyển vào Tencent WXG hoặc ByteDance một cách dễ dàng với vị thế và mức lương cao hơn rất nhiều!

![Kinh nghiệm deal lương](http://oss.interviewguide.cn/img/202209252327127.png)
