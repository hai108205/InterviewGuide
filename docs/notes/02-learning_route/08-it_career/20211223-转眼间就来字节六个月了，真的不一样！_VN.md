...
layout: post
category: algorithm
title: Thoáng cái đã ở ByteDance tròn 6 tháng, quả thực rất khác biệt!
tagline: by A Tú
tags:
    - Nguyên tác
    - Máy tính
    ...
    - A Tú
excerpt: Thoáng cái đã ở ByteDance tròn 6 tháng, quả thực rất khác biệt!
comment: false
---

<h1 align="center">Thoáng cái đã ở ByteDance tròn 6 tháng, quả thực rất khác biệt!</h1>
...
> Tác giả: A Tú (阿秀)
>
> Liên kết bài viết gốc: [https://mp.weixin.qq.com/s/7PGeWiQzk7Ih99nDbw-1rg](https://mp.weixin.qq.com/s/7PGeWiQzk7Ih99nDbw-1rg)

Nhìn lại hành trình 6 tháng tại ByteDance sau khi chính thức vượt qua kỳ thử việc và ký hợp đồng chính thức:

---

### I. Nhìn lại và Phản hồi các thắc mắc
1. **Làm việc ở Big Tech có ý nghĩa gì?**: Được tiếp cận hệ thống hạ tầng phân tán khổng lồ (Infrastructure/DevOps) mà ở môi trường nhỏ khó có cơ hội trải nghiệm.
2. **Thực trạng nhân sự Frontend**: Nhu cầu tuyển dụng kỹ sư Frontend chất lượng cao tại các chi nhánh công nghệ cực kỳ lớn (do chương trình đại học ít đào tạo sâu về Vue/React/JavaScript hiện đại).
3. **Tuyển dụng Fullstack ở sinh viên mới ra trường?**: Thực tế gần như không có ứng viên mới tốt nghiệp nào hoàn thiện Fullstack ngay; đa phần đều thành thạo vững chắc một mảng (Frontend hoặc Backend) và mở rộng dần trong quá trình làm việc thực tế.

---

### II. Sự chuyển biến sau 6 tháng làm việc thực chiến
- **Nâng cao tầm nhìn về sản phẩm (Product Mindset)**: Không chỉ dừng lại ở việc gõ code máy móc hoàn thành Task, mà bắt đầu đào sâu lý do tại sao nghiệp vụ (Business) lại cần tính năng này và giá trị mang lại cho người dùng cuối là gì.
- **Tối ưu hóa nhịp độ công việc**: Từ chỗ phải ở lại tới 22:00 để tìm hiểu hệ thống sang việc chủ động phân chia Sprint khoa học, hoàn thành công việc chỉn chu và rời công ty lúc 20:30.
- **Tự giác nâng cấp bản thân ngoài giờ làm**: Duy trì thói quen thức dậy lúc 7:30 sáng để đọc sách công nghệ chuyên sâu (Microservices, Distributed Systems, Cloud Native) trước khi đến công ty.

![Tài khoản Zhihu của tác giả](http://oss.interviewguide.cn/img/202205220049054.png)
