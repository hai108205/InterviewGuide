...
layout: post
category: algorithm
title: Kèm một bạn thực tập sinh, tôi mới thấm thía cảm giác làm mẹ
tagline: by A Tú
tags:
    - Nguyên tác
    - Máy tính
    ...
    - A Tú
excerpt: Kèm một bạn thực tập sinh, tôi mới thấm thía cảm giác làm mẹ
comment: false
---

<h1 align="center">Kèm một bạn thực tập sinh, tôi mới thấm thía cảm giác làm mẹ</h1>
...
> Tác giả: A Tú (阿秀)
>
> Liên kết bài viết gốc: [https://mp.weixin.qq.com/s/vTfxNtmlLsFRroVeqD_v7A](https://mp.weixin.qq.com/s/vTfxNtmlLsFRroVeqD_v7A)

![Cảm xúc khi hướng dẫn thực tập sinh](http://oss.interviewguide.cn/img/202204060048525.png)
![Chia sẻ kinh nghiệm làm việc từ xa](http://oss.interviewguide.cn/img/202204060049622.png)

Đúc kết phương pháp kèm cặp và giúp đỡ thực tập sinh / tân binh mới vào nghề phát triển vượt bậc:

---

### 1. Chọn điểm cắt ngang cụ thể để bắt đầu (Entry Point)
- Đừng bắt người mới đọc toàn bộ source code của cả một dự án khổng lồ.
- **Đối với Frontend**: Chọn một trang UI tiêu biểu $\rightarrow$ Phân tích điều kiện kích hoạt, Component dùng chung, cơ chế gọi API và vòng đời render dữ liệu.
- **Đối với Backend**: Chọn một API điển hình $\rightarrow$ Đi theo luồng Controller Validation $\rightarrow$ Business Service $\rightarrow$ Data Access DAO $\rightarrow$ Xử lý Transaction và mã phản hồi (Response Code).

---

### 2. Chủ động hỏi thăm khó khăn & Tổ chức Code Review định kỳ
- Tân binh thường e ngại, sợ làm phiền Mentor nên thường giấu khó khăn và bế tắc một mình. Mentor cần chủ động hỏi thăm định kỳ $1 \sim 2$ ngày/lần trong tuần đầu tiên.
- Dành thời gian chiều thứ 6 hàng tuần để cùng review code, gỡ các điểm tắc nghẽn về logic và chuẩn hóa cú pháp, phong cách viết code sạch (Clean Code).

![Hướng dẫn review code cùng thực tập sinh](http://oss.interviewguide.cn/img/202204060019685.png)
