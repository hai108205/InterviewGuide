...
layout: post
category: algorithm
title: Hầu hết các offer của tôi đều là SP - Tổng kết 3 năm học cao học và bí quyết săn offer
tagline: by A Tú
tags:
    - Nguyên tác
    - Máy tính
    ...
    - A Tú
excerpt: Hầu hết các offer của tôi đều là SP - Tổng kết 3 năm học cao học và bí quyết săn offer
comment: false
---

<h1 align="center">
Hầu hết các offer của tôi đều là SP - Tổng kết 3 năm học cao học và bí quyết săn offer
</h1>
...
> Tác giả: A Tú (阿秀)
>
> Liên kết bài viết gốc: [https://mp.weixin.qq.com/s/o-W7Nbm0ZFxjWx8v5XrA2Q](https://mp.weixin.qq.com/s/o-W7Nbm0ZFxjWx8v5XrA2Q)

Tổng hợp danh sách các offer SP xuất sắc trong đợt tuyển dụng bổ sung mùa thu và mùa xuân:
- **Sangfor** (An toàn mạng)
- **Beike (Ke.com)**: Client Dev Engineer (Return Offer sau thực tập)
- **Geek+**: Robot Systems Dev Engineer
- **Xiaomi**: Camera Dept Dev Engineer (SP Offer)
- **Shopee**: Client Dev Engineer (SP Offer)
- **Meituan (Waimai)**: Backend Dev Engineer
- **Baidu (Baidu Search)**: Backend Dev Engineer (SP Offer)
- **Duxiaoman (Fintech)**: Backend Dev Engineer (SP Offer)

---

### Quá trình học tập & Rèn luyện:
1. **Giai đoạn đầu**: Đọc tài liệu và luyện LeetCode từ 8:00 - 12:00 sáng mỗi ngày, buổi chiều học video thuật toán, buổi tối xem lại bài giải.
2. **Kỳ thực tập tại Ke.com**: Học Objective-C kết hợp C++, tham gia chu kỳ phát triển Agile/Scrum (13 ngày/sprint), rèn luyện khả năng đọc hiểu mã nguồn thực tế của doanh nghiệp.

![Môi trường làm việc thực tập](http://oss.interviewguide.cn/img/202205121814519.png)
![Bảo vệ chuyển chính thức](http://oss.interviewguide.cn/img/202205121814367.png)

3. **Giai đoạn tăng tốc chuyển sang Backend**:
   - Ôn tập bộ tài liệu PDF của A Tú 5-6 lần.
   - Nắm sâu kiến thức Redis, Linux Command, Hệ điều hành và Thiết kế Kiến trúc Backend.

![Sổ tay ghi chép sau các vòng phỏng vấn](http://oss.interviewguide.cn/img/202205121814344.jpg)

### Bí quyết đúc kết:
- Dự án trên CV phải ăn khớp với vị trí ứng tuyển.
- Không dùng từ "tinh thông" (Expert) một cách bừa bãi trong CV, hãy ghi "nắm vững" hoặc "quen thuộc" để chủ động dẫn dắt người phỏng vấn vào vùng kiến thức thế mạnh.
- Phục bàn và ghi chép chi tiết câu hỏi sau mỗi buổi phỏng vấn để hoàn thiện lỗ hổng kiến thức.
