...
layout: post
category: algorithm
title: Gợi ý vài dự án C++ chất lượng - Vừa học được kiến thức vừa làm đẹp CV
tagline: by A Tú
tags:
    - Nguyên tác
    - Máy tính
    ...
    - A Tú
excerpt: Gợi ý vài dự án C++ chất lượng - Vừa học được kiến thức vừa làm đẹp CV
comment: false
---

<h1 align="center">Gợi ý vài dự án C++ chất lượng - Vừa học được kiến thức vừa làm đẹp CV</h1>

> Tác giả: A Tú
>
> Liên kết bài gốc: [https://mp.weixin.qq.com/s/LopXj5XkUbOSgESV-sOf4w](https://mp.weixin.qq.com/s/LopXj5XkUbOSgESV-sOf4w)
...
Khác với Java thường phát triển các hệ thống nghiệp vụ (e-Commerce, Flash Sale, Quản lý phân tán), C++ là ngôn ngữ gần với tầng hệ điều hành và phần cứng, rất thích hợp để tự tay xây dựng các thư viện và hạ tầng hệ thống (Bánh xe công nghệ):

---

### 6 Dự án C++ từ cơ bản đến nâng cao:

1. **Tự xây dựng Trình phân tích cú pháp JSON Parser từ số 0**:
   - Dự án hướng dẫn từng bước cài đặt JSON Parser/Generator bằng C++ chuẩn.
   - [Repo GitHub json-tutorial](https://github.com/miloyip/json-tutorial)
2. **Hiện thực thư viện STL cho riêng bạn (MyTinySTL)**:
   - Viết lại hầu hết các Container (Vector, List, Deque, Map, Set, Unordered_Map), Allocator và Thuật toán trên nền tảng C++11.
   - [Repo GitHub MyTinySTL](https://github.com/Alinshans/MyTinySTL)
3. **HTTP WebServer trên nền tảng Linux**:
   - Dự án kinh điển cho kỹ sư C++ Backend. Bổ sung các tính năng nâng cao: Thread Pool, Non-blocking Socket, Epoll Event Loop, Timer quản lý kết nối không hoạt động, Logger bất đồng bộ.
   - [Repo GitHub WebServer của Lin Ya](https://github.com/linyacool/WebServer)
4. **Máy chủ mạng đa luồng (Multi-threaded Network Server)**:
   - Ứng dụng Reactor Pattern, Epoll, C++11 Smart Pointers để xây dựng NetServer hiệu năng cao.
   - [Repo GitHub NetServer](https://github.com/chenshuaihao/NetServer)
5. **Khung máy chủ phân tán hiệu năng cao C++ (Sylar Framework)**:
   - Độ khó nâng cao: Hệ thống gồm 13 module (Coroutine / Fiber, Coroutine Scheduler, I/O Hooking, Socket, Http/Servlet, ByteArray Serialization).
   - [Repo GitHub Sylar](https://github.com/sylar-yin/sylar)
6. **Xây dựng Nhân hệ điều hành (OS Kernel - MIT 6.828 Labs)**:
   - Thực hiện các bài Lab của trường MIT (kết hợp sách CSAPP) để hiểu sâu về Memory Management, Trap Handling, Multitasking và File System.
   - [Repo GitHub MIT 6.828 Labs](https://github.com/woai3c/MIT6.828)
