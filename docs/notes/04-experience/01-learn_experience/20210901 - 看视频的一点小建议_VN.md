...
layout: post
category: algorithm
title: Đôi điều lời khuyên khi học lập trình qua Video
tagline: by A Tú
tags:
    - Nguyên tác
    - Máy tính
    ...
    - A Tú
excerpt: Đôi điều lời khuyên khi học lập trình qua Video
comment: false
---

<h1 align="center">Đôi điều lời khuyên khi học lập trình qua Video</h1>

> Tác giả: A Tú
>
> Liên kết bài gốc: [https://mp.weixin.qq.com/s/rXprhIxwYGRJoRWyhS-lvQ](https://mp.weixin.qq.com/s/rXprhIxwYGRJoRWyhS-lvQ)
...
Phương pháp tối ưu hóa hiệu quả khi tự học công nghệ thông tin qua các khóa học Video:

---

### I. Đối với các khóa học thiên về Thực chiến (Ngôn ngữ lập trình, Frameworks, Dự án)
- **BẮT BUỘC PHẢI TỰ TAY GÕ CODE**: Tuyệt đối không chỉ ngồi nhìn thụ động.
- **Giai đoạn đầu: "Sao chép chính xác 100%"**:
  - Khi mới bắt đầu tiếp cận ngôn ngữ hoặc công nghệ mới, hãy gõ lại y nguyên từng tên biến, cấu trúc hàm và cách bố trí tệp giống như giảng viên để hạn chế tối đa các lỗi cú pháp ngớ ngẩn.
  - Tự tay tạo commit Git cho từng tính năng nhỏ.
- ![Dự án Element UI + Vue](./picture/202205220009016.png)
- ![Dự án Vuex](./picture/202205220009065.png)

---

### II. Đối với các khóa học thiên về Lý thuyết (Hệ điều hành, Mạng máy tính, Kiến trúc máy tính)
- **Dùng Video để nhập môn trực quan hóa kiến thức $\rightarrow$ Sau đó đọc sách kinh điển để đào sâu bản chất**:
  - Video giúp bạn nhanh chóng nắm bắt bức tranh toàn cảnh mà không bị ngợp.
  - Sau khi nắm được mạch kiến thức, hãy chuyển sang đọc các cuốn sách kinh điển (CSAPP, TCP/IP Illustrated) và tự tay thực hành bắt gói tin Wireshark để nắm trọn vẹn bản chất gốc rễ.
- **Tùy chỉnh tốc độ video**: Tăng tốc $1.5 \times \sim 2.0 \times$ ở những phần đã hiểu để tiết kiệm thời gian.
